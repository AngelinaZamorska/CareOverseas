...
const CountriesSection = () => {
  ...
  // добавили slug для стран, у которых есть отдельные страницы
  const countriesData = [
    {
      slug: 'germany',
    ...
    {
      slug: 'turkey', // ✅ теперь Турция ведёт на страницу
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Германия и Турция → на страницы, остальное — скролл к контакту */}
                  {hasPage ? (
                    <Link
