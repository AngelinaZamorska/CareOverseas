...
import { Dna, Beaker, ShieldCheck, Microscope, Euro, CheckCircle, ArrowRight } from 'lucide-react';
                ...
                <section className="relative py-24 bg-gradient-to-br from-indigo-600/10 to-purple-600/10 overflow-hidden">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            ...
                            <Button asChild size="lg" className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white text-lg px-8 py-4">
                                <Link to="/#contact">{t('dendriticCellPage.inquire')} <ArrowRight className="ml-2 h-5 w-5" /></Link>
                            </Button>
                        </motion.div>
                    </div>
                </section>
                ...
                <section className="py-20">
                    <div className="container mx-auto px-6">
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                        >
                            <h2 className="text-4xl font-bold text-gray-900 mb-4">{t('dendriticCellPage.whyGermanyTitle')}</h2>
                            <p className="text-lg text-gray-600 max-w-2xl mx-auto">{t('dendriticCellPage.whyGermanySubtitle')}</p>
                        </motion.div>
                ...
                <section className="py-20 bg-white">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            ...
                            <Button asChild size="lg" variant="secondary" className="bg-white text-indigo-600 hover:bg-gray-100 text-lg px-8 py-4">
