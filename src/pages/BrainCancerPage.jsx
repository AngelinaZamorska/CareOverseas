                ...
                <section className="relative py-24 bg-gradient-to-br from-slate-600/10 to-gray-600/10 overflow-hidden">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            ...
                            <Button asChild size="lg" className="bg-gradient-to-r from-slate-800 to-gray-700 hover:from-slate-900 hover:to-gray-800 text-lg px-8 py-4">
                                <Link to="/#contact">{t('neurosurgeryPage.getQuote')} <ArrowRight className="ml-2 h-5 w-5" /></Link>
                            </Button>
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                            >
                                <img alt="Advanced MRI scan of a human brain" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1624969862293-c7eb7c97a133" />
                            </motion.div>
                             <motion.div 
                                className="space-y-6"
                                initial={{ opacity: 0, x: 20 }}
                ...
                <section className="py-20 bg-white">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            ...
                            <Button asChild size="lg" variant="secondary" className="bg-white text-slate-800 hover:bg-gray-100 text-lg px-8 py-4">
                                <Link to="/#contact">{t('neurosurgeryPage.ctaButton')}</Link>
                            </Button>
                        </motion.div>
                    </div>
                </section>
