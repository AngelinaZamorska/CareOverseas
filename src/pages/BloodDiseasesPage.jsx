    ...
    <>
      ...
      <div className="bg-white">
        ...
        <section className="relative py-24 bg-gradient-to-br from-red-600/10 to-rose-600/10 overflow-hidden">
          <div className="container mx-auto px-6 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <Button size="lg" className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-lg px-8 py-4" onClick={handleContactClick}>
          ...
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <motion.div className="relative h-96 md:h-auto rounded-lg overflow-hidden shadow-lg" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <img alt="Blood analysis and cancer diagnostics" className="rounded-xl shadow-lg w-full sm:max-w-[90%] md:max-w-[80%] lg:max-w-[60%] xl:max-w-[50%]" src="/og-blood-v2.jpg" />
              </motion.div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6 text-center">
            <motion.div className="bg-gradient-to-r from-red-600 to-rose-600 text-white p-12 rounded-2xl shadow-xl" initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}>
              ...
              <Button size="lg" variant="secondary" className="bg-white text-red-600 hover:bg-gray-100 text-lg px-8 py-4" onClick={handleContactClick}>
