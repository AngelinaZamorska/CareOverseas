        ...
        <section className="relative py-24 bg-gradient-to-br from-red-600/10 to-rose-600/10 overflow-hidden">
          <div className="container mx-auto px-6 text-center">
            ...
            >
              ...
              <Button
                size="lg"
                className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-lg px-8 py-4"
        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                className="w-full max-w-lg mx-auto overflow-hidden rounded-xl shadow-lg"
