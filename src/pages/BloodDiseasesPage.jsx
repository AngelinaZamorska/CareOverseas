                    ...
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            ...
                            <Button asChild size="lg" className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-lg px-8 py-4">
                                <Link to="/#contact">{t('bloodDiseasesPage.getQuote')} <ArrowRight className="ml-2 h-5 w-5" /></Link>
                            </Button>
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                            >
                                <img alt="Scientist looking at blood cells under a microscope" className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1578496479531-32e296d5c837" />
                            </motion.div>
                             <motion.div 
                                className="space-y-6"
                                initial={{ opacity: 0, x: 20 }}
