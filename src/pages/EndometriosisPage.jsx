    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href="https://yourdomain.com/endometriosis-treatment" />
            </Helmet>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[UserMd, FlaskConical, HeartPulse, CheckCircle].map((Icon, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold mb-2">{t(`endometriosisPage.feature${index + 1}Title`)}</h3>
                                    <p className="text-gray-600">{t(`endometriosisPage.feature${index + 1}Desc`)}</p>
                                </motion.div>
                            ))}
                        </div>
                    </div>
                                ...
                                <ul className="space-y-3 text-gray-700">
                                    {[1,2,3,4,5].map((i) => (
                                        <li key={i} className="flex items-start">
                                            ...
                                            <span><Trans i18nKey={`endometriosisPage.modality${i}`} components={{ strong: <strong /> }} /></span>
                                        </li>
                                    ))}
                                </ul>
                            </motion.div>
