                ...
                <section className="relative py-24 bg-gradient-to-br from-cyan-600/10 to-sky-600/10 overflow-hidden">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            ...
                            <Button asChild size="lg" className="bg-gradient-to-r from-cyan-600 to-sky-600 hover:from-cyan-700 hover:to-sky-700 text-lg px-8 py-4">
                                <Link to="/#contact">{t('rheumatologyIsraelPage.getQuote')} <ArrowRight className="ml-2 h-5 w-5" /></Link>
                            </Button>
                        </motion.div>
                    </div>
                </section>
                ...
                <section className="py-20">
                    <div className="container mx-auto px-6">
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                        >
                            <h2 className="text-4xl font-bold text-gray-900 mb-4">{t('rheumatologyIsraelPage.whyIsraelTitle')}</h2>
                            <p className="text-lg text-gray-600 max-w-2xl mx-auto">{t('rheumatologyIsraelPage.whyIsraelSubtitle')}</p>
                        </motion.div>
                ...
                <section className="py-20 bg-white">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            ...
                            <Button asChild size="lg" variant="secondary" className="bg-white text-cyan-600 hover:bg-gray-100 text-lg px-8 py-4">
                                <Link to="/#contact">{t('rheumatologyIsraelPage.ctaButton')}</Link>
                            </Button>
                        </motion.div>
                    </div>
                </section>
