...
export default function PlasticSurgeryTurkeyPage() {
  ...
  return (
    <div className="text-base leading-relaxed">
      ...
      {/* Hero Section */}
      <section className="relative py-24 bg-gradient-to-br from-pink-50 to-fuchsia-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-pink-600 to-fuchsia-600 hover:from-pink-700 hover:to-fuchsia-700 text-white px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold"
              onClick={handleContactClick}
            >
              {t('plasticSurgeryPage.getQuote')} <ArrowRight className="ml-2 h-5 w-5 inline" />
            </Button>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            className="bg-gradient-to-r from-pink-600 to-fuchsia-600 text-white p-10 rounded-2xl shadow-xl max-w-2xl mx-auto"
            initial={{ scale: 0.95 }}
            whileInView={{ scale: 1 }}
            viewport={{ once: true }}
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
              {t('plasticSurgeryPage.ctaTitle')}
            </h2>
            <p className="text-sm sm:text-lg mb-6 max-w-2xl mx-auto">
              {t('plasticSurgeryPage.ctaSubtitle')}
            </p>
            <Button
              size="lg"
