                ...
                <section className="relative py-24 bg-gradient-to-br from-pink-600/10 to-fuchsia-600/10 overflow-hidden">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            ...
                            <Button asChild size="lg" className="bg-gradient-to-r from-pink-600 to-fuchsia-600 hover:from-pink-700 hover:to-fuchsia-700 text-white text-lg px-8 py-4">
                                <Link to="/#contact">{t('plasticSurgeryPage.getQuote')} <ArrowRight className="ml-2 h-5 w-5" /></Link>
                            </Button>
                        </motion.div>
                    </div>
                </section>
                ...
                <section className="py-20 bg-white">
                    <div className="container mx-auto px-6 text-center">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-gradient-to-r from-pink-600 to-fuchsia-600 text-white p-12 rounded-2xl shadow-xl"
                        >
                            ...
                            <Button asChild size="lg" variant="secondary" className="bg-white text-pink-600 hover:bg-gray-100 text-lg px-8 py-4">
                                <Link to="/#contact">{t('plasticSurgeryPage.ctaButton')}</Link>
                            </Button>
                        </motion.div>
                    </div>
                </section>
